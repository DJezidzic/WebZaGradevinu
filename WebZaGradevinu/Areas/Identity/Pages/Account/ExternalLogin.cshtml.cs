...
namespace WebZaGradevinu.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            {
                var user = new AppUser { UserName = Input.Email, Email = Input.Email, OIB = Input.OIB, NazivTvrtke = Input.NazivTvrtke };
                var comp = new Company { NazivTvrtke = Input.NazivTvrtke, Email = Input.Email, OIB = Input.OIB };
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        this._dbContext.Companies.Add(comp);
